  ...
  _createClass(UITree, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        { className: 'm-tree' },
        draggingDom,
        _react2.default.createElement(_node2.default, (_React$createElement = {
          tree: tree,
          index: tree.getIndex(1),
          key: 1,
          paddingLeft: this.props.paddingLeft,
          onDragStart: this.dragStart
        }, _defineProperty(_React$createElement, 'onDragStart', this.props.draggable && this.dragStart), _defineProperty(_React$createElement, 'onCollapse', this.toggleCollapse), _defineProperty(_React$createElement, 'dragging', dragging && dragging.id), _React$createElement))
      );
    }
